...
@section('backgroundimg')
    <style>
        body{
            background-image: url({{URL::asset('images/loginbg.jpg')}});
        }
    </style>
@stop
...
@section('content')
<div class="container">
    <div style="margin-bottom:50px;" class="row text-center">
        <div class="title">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('password.request') }}">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password-confirm" class="col-md-4 control-label">Confirmer son mot de passe</label>
                            <div class="col-md-6">
